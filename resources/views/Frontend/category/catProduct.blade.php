                        ...
                        <ul class="breadcrumb premium-breadcrumb bg-transparent p-0 mb-4">
                            ...
                            @if($categoryType == 'category')
                                <li class="breadcrumb-item active">
                                    <a href="{{ route('catProductView', $category->slug) }}">{{ $category->name }}</a>
                                </li>
                            @elseif($categoryType == 'subcategory')
                                <li class="breadcrumb-item">
                                    <a href="{{ route('catProductView', $parentCategory->slug) }}">{{ $parentCategory->name }}</a>
                                </li>
                                <li class="breadcrumb-item active">
                                    <a href="{{ route('subCatProductView', [$parentCategory->slug, $category->slug]) }}">{{ $category->name }}</a>
                                </li>
                            @elseif($categoryType == 'childcategory')
                                <li class="breadcrumb-item">
                                    <a href="{{ route('catProductView', $parentCategory->slug) }}">{{ $parentCategory->name }}</a>
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('subCatProductView', [$parentCategory->slug, $parentSubCategory->slug]) }}">{{ $parentSubCategory->name }}</a>
                                </li>
                                <li class="breadcrumb-item active">
                                    <a href="{{ route('childCatProductView', [$parentCategory->slug, $parentSubCategory->slug, $category->slug]) }}">{{ $category->name }}</a>
                                </li>
                            @endif
                        </ul>
