                ...
                <form action="{{ route('slider.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="image-upload-box" onclick="document.getElementById('image-input').click()" style="border: none;">
                            <img src="{{ asset('adminDash/uploads/slider&banner/' . $slider->image) }}" alt="Current Image" id="preview-img">
                            <div class="overlay">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" class="form-control form-control-lg" name="url" value="{{ $slider->url }}" placeholder="https://example.com" style="border-radius: 12px;">
                    </div>

                    <div class="d-flex justify-content-end gap-3 mt-4">
                        <a href="{{ route('slider.index') }}" class="btn btn-light px-4 py-2" style="border-radius: 50px; font-weight: 600;">Cancel</a>
                        <button type="submit" class="btn btn-gradient-primary ml-2">Update Slider</button>
                    </div>
                </form>
            </div>
        </div>
