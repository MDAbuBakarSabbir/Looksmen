	...
	<div class="col-sm-12">
		...
		<div class="card">
			<div class="card-header">
				<h5 class="mb-0 h6">Affiliate Registration Form</h5>
			</div>
			<div class="card-body">
				<form action="{{ route('affiliate.configs.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-lg-8 form-horizontal" id="form">
							@php
								$verification_config = \App\Models\AffiliateConfig::where('type', 'verification_form')->first();
								$verification_elements = [];
								if ($verification_config && $verification_config->value) {
									$verification_elements = json_decode($verification_config->value);
								}
							@endphp
							@foreach ($verification_elements as $key => $element)
