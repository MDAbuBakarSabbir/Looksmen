...
<head>
    ...
    <audio id="orderAlertSound" preload="auto">
        <source src="{{ asset('adminDash/assets/sound/notification.mp3') }}" type="audio/mpeg">
    </audio>
...
<body>
    ...
    <!-- Required vendors -->
    <script src="{{ asset('adminDash/assets/vendor/global/global.min.js') }}"></script>
    <script src="{{ asset('adminDash/assets/js/quixnav-init.js') }}"></script>
