...
Route::prefix('admin')->middleware('auth:admin')->group(function () {
    ...
    Route::controller(AttributeController::class)->group(function () {
        ...
        Route::match(['GET', 'POST'], 'attributevalues/update/{id}', 'valueUpdate')->name('attribute.value.update')->middleware('admin.permission:create_attribute');
        Route::match(['GET', 'POST'], 'attributes/value/update/{id}', 'valueUpdate')->middleware('admin.permission:create_attribute');
